...
class Trainer():
    ...
    def __init__(self, args, Loader, device, n_classes=1):
        ...
        self.te_macro_Precision = -1.
        self.te_micro_Recall = -1.
    ...
    def CalMetric_Crack500(self, pred, gt):
        ...
        AIU=-1
        micro_F1, macro_F1, macro_Precision, macro_Recall = self.evaluator.F1(pred, gt)
        ...
        return perpix_acc, persamp_iou, micro_iou, AIU, micro_F1, macro_F1, macro_Precision, macro_Recall
