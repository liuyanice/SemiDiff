...
class Trainer(UnetTrainer):
    ...
    def TrainOneEpoch(self, writer=None, max_itr=np.inf):
        ...
        while True:
            ...
            train_labeled_data_view1, train_labeled_gt_view1 = \
                self.ApplyAugmentation_Mask(train_labeled_data, train_labeled_gt)
            train_labeled_data_view2, train_labeled_gt_view2 = \
                self.ApplyAugmentation_Mask(train_labeled_data, train_labeled_gt)

            if w != 0.0:
                train_unlabeled_data_view1, train_unlabeled_gt_view1 = \
                    self.ApplyAugmentation_Mask(train_unlabeled_data, train_unlabeled_gt)
                train_unlabeled_data_view2, train_unlabeled_gt_view2 = \
                    self.ApplyAugmentation_Mask(train_unlabeled_data, train_unlabeled_gt)
            ...
            if w != 0.0:
                ...
                if self.loss_name == 'Dice+ConsistMSEall_loss':
                    ...
                    train_labeled_pred_view1_aligned = train_labeled_pred_view1
                                                                                                 
                    train_labeled_pred_view2_aligned = train_labeled_pred_view2
                ...
                # unlabeled data
                train_unlabeled_pred_view1_aligned = train_unlabeled_pred_view1
                train_unlabeled_pred_view2_aligned = train_unlabeled_pred_view2
