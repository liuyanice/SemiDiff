...
class Trainer(UnetTrainer):
    ...
    #
    #         if w != 0.0:
    #             train_unlabeled_data_viewteach, train_unlabeled_gt_viewteach, train_unlabeled_mask_viewteach, train_unlabeled_Tform_viewteach = \
    ...
    #             nUnlabel = train_unlabeled_data_viewteach.shape[0]
    #             CutMixMask = []
    #             H = train_labeled_data_view1.shape[2]
    #             W = train_labeled_data_view1.shape[3]
    ...
    #                 img = train_unlabeled_data_viewteach[p_i].copy()
    #                 img[:,corner_H:corner_H+box_H, corner_W:corner_W+box_W] = \
    #                     train_unlabeled_data_viewteach[p2_i,:,corner_H:corner_H+box_H, corner_W:corner_W+box_W]
    ...
    #         if w != 0.0:
    #             train_unlabeled_data_viewteach = torch.tensor(train_unlabeled_data_viewteach,device=self.device, dtype=torch.float32)
    ...
    #             train_unlabeled_data_viewteach=torch.cat([train_unlabeled_data_viewteach, x, y], dim=1)
    #             train_unlabeled_data_viewstu=torch.cat([train_unlabeled_data_viewstu, x, y], dim=1)
    ...
    #             train_unlabeled_pred_viewteach = self.net_ema(train_unlabeled_data_viewteach)   # forward pass prediction of train unlabeled set view2
    #
    #             # blend mixed images
