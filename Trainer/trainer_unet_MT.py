...
class Trainer(UnetTrainer):
    ...
    def DefineNetwork(self, net_name, loss_name):
        ...
        elif net_name == 'ResUnet_Q':
            self.net = model.ResUNet_Q(n_channels=3, n_classes=1, bilinear=False)
        elif net_name == 'ResUnet_C':
            self.net = model.ResUNet_C(n_channels=3, n_classes=1, bilinear=False)
        elif net_name == 'ResUnet_S':
            self.net = model.ResUNet_S(n_channels=3, n_classes=1, bilinear=False)
        elif net_name == 'DeepLabHeadV3Plus':
            self.net = model.DeepLabHeadV3Plus(n_channels=3, n_classes=1)
    ...
    def TrainOneEpoch(self, writer=None, max_itr=np.inf):
        ...
        while True:
            ...
            train_labeled_data_view1, train_labeled_gt_view1, train_labeled_Tform_view1, train_labeled_ElasticDeformFlow_view1 = \
                self.ApplyAugmentation_Mask(train_labeled_data, train_labeled_gt)
            train_labeled_data_view2, train_labeled_gt_view2, train_labeled_Tform_view2, train_labeled_ElasticDeformFlow_view2 = \
                self.ApplyAugmentation_Mask(train_labeled_data, train_labeled_gt)

            if w != 0.0:
                train_unlabeled_data_view1, train_unlabeled_gt_view1, train_unlabeled_Tform_view1, train_unlabeled_ElasticDeformFlow_view1 = \
                    self.ApplyAugmentation_Mask(train_unlabeled_data, train_unlabeled_gt)
                train_unlabeled_data_view2, train_unlabeled_gt_view2, train_unlabeled_Tform_view2, train_unlabeled_ElasticDeformFlow_view2 = \
                    self.ApplyAugmentation_Mask(train_unlabeled_data, train_unlabeled_gt)
            ...
            if w != 0.0:
                ...
                if self.loss_name == 'Dice+ConsistMSEall_loss':
                    ...
                    train_labeled_pred_view1_aligned = self.gt_model.invtransform_image_tensor(train_labeled_pred_view1,
                                                                                                 ...
                                                                                                 train_labeled_ElasticDeformFlow_view1)
                    train_labeled_pred_view2_aligned = self.gt_model.invtransform_image_tensor(train_labeled_pred_view2,
                                                                                                 ...
                                                                                                 train_labeled_ElasticDeformFlow_view2)
                ...
                # unlabeled data
                train_unlabeled_pred_view1_aligned = self.gt_model.invtransform_image_tensor(train_unlabeled_pred_view1, train_unlabeled_Tform_view1, train_unlabeled_ElasticDeformFlow_view1)
                train_unlabeled_pred_view2_aligned = self.gt_model.invtransform_image_tensor(train_unlabeled_pred_view2, train_unlabeled_Tform_view2, train_unlabeled_ElasticDeformFlow_view2)
               # unlabeled_mask = torch.tensor(train_unlabeled_mask_view1 * train_unlabeled_mask_view2,dtype=torch.uint8,device=self.device)   # the overlap mask between all views
                ...
                if self.loss_name == 'Dice+ConsistMSEall_loss':
                    ...
                    train_labeled_pred_view1_sel = train_labeled_pred_view1_aligned
                    train_labeled_pred_view2_sel = train_labeled_pred_view2_aligned
                ...
                # unlabeled data
                train_unlabeled_pred_view1_sel = train_unlabeled_pred_view1_aligned
                train_unlabeled_pred_view2_sel = train_unlabeled_pred_view2_aligned
    ...
    def TestAll_SavePred(self,exp_fig=False,best_ckpt_filepath=None):
        ...
        if self.target_data == 'CrackForest' or self.target_data == 'MITRoad' or \
            ...
            micro_F1, macro_F1, macro_Precision, macro_Recall = self.evaluator.F1(test_pred_bin_all, test_gt_all)
            #micro_dice, macro_dice = self.evaluator.Dice(test_pred_bin_all, test_gt_all)
        ...
        self.best_te_macro_Precision = macro_Precision
        self.best_te_macro_Recall = macro_Recall

        return epoch_loss, perpix_acc, persamp_iou, micro_iou, AIU, micro_F1, macro_F1, macro_Precision, macro_Recall
    ...
    def ApplyAugmentation_Mask(self, data, gt):
        ...
        ElasticDeformFlow = self.gt_model.ElasticDeformFlow # transformation matrices
       # print('ElasticDeformFlows1======', len(ElasticDeformFlow))
     #   print('Tform======', len(Tform))
      ...
      #  mask = np.transpose(mask, [0, 1, 2])
       ...
       # return data, gt, mask, Tform
        return data, gt, Tform, ElasticDeformFlow
