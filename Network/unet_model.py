...
class ASPPConv(nn.Sequential):
    def __init__(self, n_channels, out_channels, dilation):
        modules = [
            nn.Conv2d(n_channels, out_channels, 3, padding=dilation, dilation=dilation, bias=False),
...
class ASPPPooling(nn.Sequential):
    def __init__(self, n_channels, out_channels):
        super(ASPPPooling, self).__init__(
            ...
            nn.Conv2d(n_channels, out_channels, 1, bias=False),
            nn.BatchNorm2d(out_channels),
            nn.ReLU(inplace=True))
...
class ASPP(nn.Module):
    def __init__(self, n_channels, atrous_rates):
        ...
        modules.append(ASPPConv(n_channels, out_channels, rate1))
        modules.append(ASPPConv(n_channels, out_channels, rate2))
        modules.append(ASPPConv(n_channels, out_channels, rate3))
        modules.append(ASPPPooling(n_channels, out_channels))
...
class DeepLabHeadV3Plus(nn.Module):
    def __init__(self, n_channels=3, low_level_channels=3, n_classes=1, aspp_dilate=[12, 24, 36], ki='glorot_uniform'):
        ...
        self.aspp = ASPP(n_channels, aspp_dilate)
        ...
        self._init_weight(ki)

    def _init_weight(self, ki):
...
class ResUNet_Q(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True, ki='glorot_uniform'):
        ...
        self.ResBlock1 = ResDoubleConv_Q(n_channels+1, 32)
        self.Downscale1 = Downscale(2)
        self.ResBlock2 = ResDoubleConv_Q(32, 64)
        self.Downscale2 = Downscale(2)
        self.ResBlock3 = ResDoubleConv_Q(64, 128)
        self.Downscale3 = Downscale(2)
        self.ResBlock4 = ResDoubleConv_Q(128, 256)
        self.Downscale4 = Downscale(2)
        self.ResBlock5 = ResDoubleConv_Q(256, 512)
        self.Upscale5 = Upscale(2)
        self.ResBlock6 = ResDoubleConv_Q(512+256, 256)
        self.Upscale6 = Upscale(2)
        self.ResBlock7 = ResDoubleConv_Q(256+128, 128)
        self.Upscale7 = Upscale(2)
        self.ResBlock8 = ResDoubleConv_Q(128+64, 64)
        self.Upscale8 = Upscale(2)
        self.ResBlock9 = ResDoubleConv_Q(64+32, 32)
        self.Output = OutputLayers_Q(32, n_classes+3)
        self.r0 = ResnetBlock_Q(32, padding_type='reflect', norm_layer=nn.BatchNorm2d, use_dropout=False, use_bias=nn.BatchNorm2d, head_num=4)
        self.r1 = ResnetBlock_Q(64, padding_type='reflect', norm_layer=nn.BatchNorm2d, use_dropout=False, use_bias=nn.BatchNorm2d, head_num=4)
        self.r2 = ResnetBlock_Q(128, padding_type='reflect', norm_layer=nn.BatchNorm2d, use_dropout=False, use_bias=nn.BatchNorm2d, head_num=4)
        self.r = ResnetBlock_Q(256, padding_type='reflect', norm_layer=nn.BatchNorm2d, use_dropout=False, use_bias=nn.BatchNorm2d, head_num=4)
    ...
    def forward(self, x):
        ...
        x_q = torch.cat([x, x_mean], 1)
        ## Encoder Net
        out = self.ResBlock1(x_q)
        out =self.r0(out)
        res1 = out.clone()
...
class ResUNet_C(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True, ki='glorot_uniform'):
        ...
        self.ResBlock9 = ResDoubleConv(64+32, 32)
        self.Output = OutputLayers(32, n_classes)
        self.res0 = ResnetBlock(32, padding_type='reflect', norm_layer=nn.BatchNorm2d, use_dropout=False, use_bias=nn.BatchNorm2d, head_num=4)
        self.res1 = ResnetBlock(64, padding_type='reflect', norm_layer=nn.BatchNorm2d, use_dropout=False, use_bias=nn.BatchNorm2d, head_num=4)
        self.res2 = ResnetBlock(128, padding_type='reflect', norm_layer=nn.BatchNorm2d, use_dropout=False, use_bias=nn.BatchNorm2d, head_num=4)
        self.res = ResnetBlock(256, padding_type='reflect', norm_layer=nn.BatchNorm2d, use_dropout=False, use_bias=nn.BatchNorm2d, head_num=4)
        self._init_weights(ki)
