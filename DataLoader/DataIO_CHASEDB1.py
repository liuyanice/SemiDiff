...
class DataIO():
    ...
    def __init__(self,batch_size, seed_split=0, seed_label=0, label_percent=0.05,
                 data_path=os.path.abspath(os.path.join(pathlib.Path(__file__).parent.resolve(),'../Dataset/CHASEDB1')),
                 add_unlab = 'None'):#None
        '''
                Initialize DataIO
        ...
        self.fake_path = os.path.join(self.data_path,'samples')  # the path to images
      #  self.fake_text = self.data_path
